...
\jmlrheading{1}{2015}{1-48}{4/00}{10/00}{Bo Liu\u{a} and Ji Liu and Hao Men}

% Short headings should be running head and authors last names

\ShortHeadings{Minimum Volume Multi-Task Learning}{Liu and Liu and Men and Mahadevan and Ge and Kong}
\firstpageno{1}
